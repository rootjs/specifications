...
The Github repository for this document can be found \hyperref[here]{''https://github.com/rootjs/specifications''}, the repository for the project itself \hyperref[here]{''https://github.com/rootjs/rootjs''}.
